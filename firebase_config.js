/**
 * Configurazione Firebase per PhysioAI
 * 
 * IMPORTANTE: Questo file contiene le chiavi pubbliche di Firebase.
 * Le chiavi API web di Firebase sono sicure per essere esposte nel client.
 */
